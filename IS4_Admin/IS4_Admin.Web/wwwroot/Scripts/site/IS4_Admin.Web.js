...
(function (IS4_Admin) {
    ...
    })(Administration = IS4_Admin.Administration || (IS4_Admin.Administration = {}));
})(IS4_Admin || (IS4_Admin = {}));
var IS4_Admin;
(function (IS4_Admin) {
    var Administration;
...
(function (IS4_Admin) {
    ...
    (function (Authorization) {
        var RolesForm = /** @class */ (function (_super) {
            ...
            RolesForm.formKey = 'Authorization.Roles';
            return RolesForm;
        }(Serenity.PrefixedContext));
        Authorization.RolesForm = RolesForm;
        [,
            ['ConcurrencyStamp', function () { return Serenity.StringEditor; }],
            ['Name', function () { return Serenity.StringEditor; }],
            ['NormalizedName', function () { return Serenity.StringEditor; }]
        ].forEach(function (x) { return Object.defineProperty(RolesForm.prototype, x[0], {
            get: function () {
    ...
    })(Authorization = IS4_Admin.Authorization || (IS4_Admin.Authorization = {}));
})(IS4_Admin || (IS4_Admin = {}));
var IS4_Admin;
(function (IS4_Admin) {
    var Authorization;
    (function (Authorization) {
        var RolesRow;
        (function (RolesRow) {
            RolesRow.idProperty = 'Id';
            RolesRow.nameProperty = 'Id';
            RolesRow.localTextPrefix = 'Authorization.Roles';
            var Fields;
            (function (Fields) {
        ...
        })(RolesRow = Authorization.RolesRow || (Authorization.RolesRow = {}));
    })(Authorization = IS4_Admin.Authorization || (IS4_Admin.Authorization = {}));
})(IS4_Admin || (IS4_Admin = {}));
var IS4_Admin;
(function (IS4_Admin) {
    ...
    (function (Authorization) {
        ...
        (function (RolesService) {
            RolesService.baseUrl = 'Authorization/Roles';
            var Methods;
            (function (Methods) {
            })(Methods = RolesService.Methods || (RolesService.Methods = {}));
            [
                'Create',
                'Update',
                'Delete',
                ...
                RolesService[x] = function (r, s, o) {
                    return Q.serviceRequest(RolesService.baseUrl + '/' + x, r, s, o);
                };
                Methods[x] = RolesService.baseUrl + '/' + x;
            });
        })(RolesService = Authorization.RolesService || (Authorization.RolesService = {}));
    })(Authorization = IS4_Admin.Authorization || (IS4_Admin.Authorization = {}));
})(IS4_Admin || (IS4_Admin = {}));
var IS4_Admin;
(function (IS4_Admin) {
    var Authorization;
    (function (Authorization) {
        var UserRolesForm = /** @class */ (function (_super) {
            __extends(UserRolesForm, _super);
            function UserRolesForm() {
                return _super !== null && _super.apply(this, arguments) || this;
            }
            UserRolesForm.formKey = 'Authorization.UserRoles';
            return UserRolesForm;
        }(Serenity.PrefixedContext));
        Authorization.UserRolesForm = UserRolesForm;
        [,
            ['RoleId', function () { return Serenity.StringEditor; }]
        ].forEach(function (x) { return Object.defineProperty(UserRolesForm.prototype, x[0], {
            get: function () {
                return this.w(x[0], x[1]());
            },
            enumerable: true,
...
(function (IS4_Admin) {
    ...
    (function (Authorization) {
        ...
        (function (UserRolesRow) {
            UserRolesRow.idProperty = 'UserId';
            UserRolesRow.nameProperty = 'UserId';
            UserRolesRow.localTextPrefix = 'Authorization.UserRoles';
            var Fields;
            (function (Fields) {
        ...
        })(UserRolesRow = Authorization.UserRolesRow || (Authorization.UserRolesRow = {}));
    })(Authorization = IS4_Admin.Authorization || (IS4_Admin.Authorization = {}));
})(IS4_Admin || (IS4_Admin = {}));
var IS4_Admin;
(function (IS4_Admin) {
    ...
    (function (Authorization) {
        ...
        (function (UserRolesService) {
            UserRolesService.baseUrl = 'Authorization/UserRoles';
            var Methods;
            (function (Methods) {
            })(Methods = UserRolesService.Methods || (UserRolesService.Methods = {}));
            [
                'Create',
                'Update',
                'Delete',
                ...
                UserRolesService[x] = function (r, s, o) {
                    return Q.serviceRequest(UserRolesService.baseUrl + '/' + x, r, s, o);
                };
                Methods[x] = UserRolesService.baseUrl + '/' + x;
            });
        })(UserRolesService = Authorization.UserRolesService || (Authorization.UserRolesService = {}));
    })(Authorization = IS4_Admin.Authorization || (IS4_Admin.Authorization = {}));
})(IS4_Admin || (IS4_Admin = {}));
var IS4_Admin;
(function (IS4_Admin) {
    ...
    (function (Authorization) {
        var UsersForm = /** @class */ (function (_super) {
            ...
            UsersForm.formKey = 'Authorization.Users';
            return UsersForm;
        }(Serenity.PrefixedContext));
        Authorization.UsersForm = UsersForm;
        [,
            ['AccessFailedCount', function () { return Serenity.IntegerEditor; }],
            ['ConcurrencyStamp', function () { return Serenity.StringEditor; }],
            ['Email', function () { return Serenity.StringEditor; }],
            ['EmailConfirmed', function () { return Serenity.BooleanEditor; }],
            ['LockoutEnabled', function () { return Serenity.BooleanEditor; }],
            ['LockoutEnd', function () { return Serenity.StringEditor; }],
            ['NormalizedEmail', function () { return Serenity.StringEditor; }],
            ['NormalizedUserName', function () { return Serenity.StringEditor; }],
            ['PasswordHash', function () { return Serenity.StringEditor; }],
            ['PhoneNumber', function () { return Serenity.StringEditor; }],
            ['PhoneNumberConfirmed', function () { return Serenity.BooleanEditor; }],
            ['SecurityStamp', function () { return Serenity.StringEditor; }],
            ['TwoFactorEnabled', function () { return Serenity.BooleanEditor; }],
            ...
            ['OrgName', function () { return Serenity.StringEditor; }]
        ].forEach(function (x) { return Object.defineProperty(UsersForm.prototype, x[0], {
            get: function () {
                return this.w(x[0], x[1]());
            },
            enumerable: true,
...
(function (IS4_Admin) {
    ...
    (function (Authorization) {
        var UsersRow;
        (function (UsersRow) {
            UsersRow.idProperty = 'Id';
            UsersRow.nameProperty = 'Id';
            UsersRow.localTextPrefix = 'Authorization.Users';
            var Fields;
            (function (Fields) {
        ...
        })(UsersRow = Authorization.UsersRow || (Authorization.UsersRow = {}));
    })(Authorization = IS4_Admin.Authorization || (IS4_Admin.Authorization = {}));
})(IS4_Admin || (IS4_Admin = {}));
var IS4_Admin;
(function (IS4_Admin) {
    ...
    (function (Authorization) {
        ...
        (function (UsersService) {
            UsersService.baseUrl = 'Authorization/Users';
            var Methods;
            (function (Methods) {
        ...
        })(UsersService = Authorization.UsersService || (Authorization.UsersService = {}));
    })(Authorization = IS4_Admin.Authorization || (IS4_Admin.Authorization = {}));
})(IS4_Admin || (IS4_Admin = {}));
var IS4_Admin;
(function (IS4_Admin) {
    ...
    })(BasicSamples = IS4_Admin.BasicSamples || (IS4_Admin.BasicSamples = {}));
})(IS4_Admin || (IS4_Admin = {}));
var IS4_Admin;
(function (IS4_Admin) {
    var BasicSamples;
...
(function (IS4_Admin) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return IS4_Admin.Northwind.CustomerEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['CategoryID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return BasicSamples.FilteredLookupDetailEditor; }]].forEach(function (x) { return Object.defineProperty(FilteredLookupInDetailForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = IS4_Admin.BasicSamples || (IS4_Admin.BasicSamples = {}));
})(IS4_Admin || (IS4_Admin = {}));
var IS4_Admin;
(function (IS4_Admin) {
...
(function (IS4_Admin) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return IS4_Admin.Northwind.CustomerEditor; }], ['CustomerContactName', function () { return Serenity.StringEditor; }], ['CustomerContactTitle', function () { return Serenity.StringEditor; }], ['CustomerCity', function () { return Serenity.StringEditor; }], ['CustomerRegion', function () { return Serenity.StringEditor; }], ['CustomerCountry', function () { return Serenity.StringEditor; }], ['CustomerPhone', function () { return Serenity.StringEditor; }], ['CustomerFax', function () { return Serenity.StringEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['RequiredDate', function () { return Serenity.DateEditor; }], ['EmployeeID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return IS4_Admin.Northwind.OrderDetailsEditor; }]].forEach(function (x) { return Object.defineProperty(PopulateLinkedDataForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = IS4_Admin.BasicSamples || (IS4_Admin.BasicSamples = {}));
})(IS4_Admin || (IS4_Admin = {}));
var IS4_Admin;
(function (IS4_Admin) {
...
(function (IS4_Admin) {
    ...
    (function (BasicSamples) {
        ...
        [['StaticText', function () { return IS4_Admin.StaticTextBlock; }], ['SomeInput', function () { return Serenity.StringEditor; }], ['HtmlList', function () { return IS4_Admin.StaticTextBlock; }], ['FromLocalText', function () { return IS4_Admin.StaticTextBlock; }], ['DisplayFieldValue', function () { return IS4_Admin.StaticTextBlock; }]].forEach(function (x) { return Object.defineProperty(StaticTextBlockForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = IS4_Admin.BasicSamples || (IS4_Admin.BasicSamples = {}));
})(IS4_Admin || (IS4_Admin = {}));
var IS4_Admin;
(function (IS4_Admin) {
    ...
    })(Common = IS4_Admin.Common || (IS4_Admin.Common = {}));
})(IS4_Admin || (IS4_Admin = {}));
var IS4_Admin;
(function (IS4_Admin) {
    var Common;
...
var IS4_Admin;
(function (IS4_Admin) {
    var IdentityServer_Clients;
    (function (IdentityServer_Clients) {
        var ClientsForm = /** @class */ (function (_super) {
            __extends(ClientsForm, _super);
            function ClientsForm() {
                return _super !== null && _super.apply(this, arguments) || this;
            }
            ClientsForm.formKey = 'IdentityServer_Clients.Clients';
            return ClientsForm;
        }(Serenity.PrefixedContext));
        IdentityServer_Clients.ClientsForm = ClientsForm;
        [,
            ['AbsoluteRefreshTokenLifetime', function () { return Serenity.IntegerEditor; }],
            ['AccessTokenLifetime', function () { return Serenity.IntegerEditor; }],
            ['AccessTokenType', function () { return Serenity.IntegerEditor; }],
            ['AllowAccessTokensViaBrowser', function () { return Serenity.BooleanEditor; }],
            ['AllowOfflineAccess', function () { return Serenity.BooleanEditor; }],
            ['AllowPlainTextPkce', function () { return Serenity.BooleanEditor; }],
            ['AllowRememberConsent', function () { return Serenity.BooleanEditor; }],
            ['AlwaysIncludeUserClaimsInIdToken', function () { return Serenity.BooleanEditor; }],
            ['AlwaysSendClientClaims', function () { return Serenity.BooleanEditor; }],
            ['AuthorizationCodeLifetime', function () { return Serenity.IntegerEditor; }],
            ['BackChannelLogoutSessionRequired', function () { return Serenity.BooleanEditor; }],
            ['BackChannelLogoutUri', function () { return Serenity.StringEditor; }],
            ['ClientClaimsPrefix', function () { return Serenity.StringEditor; }],
            ['ClientId', function () { return Serenity.StringEditor; }],
            ['ClientName', function () { return Serenity.StringEditor; }],
            ['ClientUri', function () { return Serenity.StringEditor; }],
            ['ConsentLifetime', function () { return Serenity.IntegerEditor; }],
            ['Description', function () { return Serenity.StringEditor; }],
            ['EnableLocalLogin', function () { return Serenity.BooleanEditor; }],
            ['Enabled', function () { return Serenity.BooleanEditor; }],
            ['FrontChannelLogoutSessionRequired', function () { return Serenity.BooleanEditor; }],
            ['FrontChannelLogoutUri', function () { return Serenity.StringEditor; }],
            ['IdentityTokenLifetime', function () { return Serenity.IntegerEditor; }],
            ['IncludeJwtId', function () { return Serenity.BooleanEditor; }],
            ['LogoUri', function () { return Serenity.StringEditor; }],
            ['PairWiseSubjectSalt', function () { return Serenity.StringEditor; }],
            ['ProtocolType', function () { return Serenity.StringEditor; }],
            ['RefreshTokenExpiration', function () { return Serenity.IntegerEditor; }],
            ['RefreshTokenUsage', function () { return Serenity.IntegerEditor; }],
            ['RequireClientSecret', function () { return Serenity.BooleanEditor; }],
            ['RequireConsent', function () { return Serenity.BooleanEditor; }],
            ['RequirePkce', function () { return Serenity.BooleanEditor; }],
            ['SlidingRefreshTokenLifetime', function () { return Serenity.IntegerEditor; }],
            ['UpdateAccessTokenClaimsOnRefresh', function () { return Serenity.BooleanEditor; }]
        ].forEach(function (x) { return Object.defineProperty(ClientsForm.prototype, x[0], {
            get: function () {
                return this.w(x[0], x[1]());
            },
            enumerable: true,
    ...
    })(IdentityServer_Clients = IS4_Admin.IdentityServer_Clients || (IS4_Admin.IdentityServer_Clients = {}));
})(IS4_Admin || (IS4_Admin = {}));
var IS4_Admin;
(function (IS4_Admin) {
    var IdentityServer_Clients;
    (function (IdentityServer_Clients) {
        var ClientsRow;
        (function (ClientsRow) {
            ClientsRow.idProperty = 'Id';
            ClientsRow.nameProperty = 'BackChannelLogoutUri';
            ClientsRow.localTextPrefix = 'IdentityServer_Clients.Clients';
            var Fields;
            (function (Fields) {
        ...
        })(ClientsRow = IdentityServer_Clients.ClientsRow || (IdentityServer_Clients.ClientsRow = {}));
    })(IdentityServer_Clients = IS4_Admin.IdentityServer_Clients || (IS4_Admin.IdentityServer_Clients = {}));
})(IS4_Admin || (IS4_Admin = {}));
var IS4_Admin;
(function (IS4_Admin) {
    ...
    (function (IdentityServer_Clients) {
        ...
        (function (ClientsService) {
            ClientsService.baseUrl = 'IdentityServer_Clients/Clients';
            var Methods;
            (function (Methods) {
            ...
            [
                ...
                ClientsService[x] = function (r, s, o) {
                    return Q.serviceRequest(ClientsService.baseUrl + '/' + x, r, s, o);
                };
                Methods[x] = ClientsService.baseUrl + '/' + x;
            });
        })(ClientsService = IdentityServer_Clients.ClientsService || (IdentityServer_Clients.ClientsService = {}));
    })(IdentityServer_Clients = IS4_Admin.IdentityServer_Clients || (IS4_Admin.IdentityServer_Clients = {}));
})(IS4_Admin || (IS4_Admin = {}));
var IS4_Admin;
(function (IS4_Admin) {
    ...
    })(Meeting = IS4_Admin.Meeting || (IS4_Admin.Meeting = {}));
})(IS4_Admin || (IS4_Admin = {}));
var IS4_Admin;
(function (IS4_Admin) {
    var Meeting;
...
(function (IS4_Admin) {
    ...
    })(Membership = IS4_Admin.Membership || (IS4_Admin.Membership = {}));
})(IS4_Admin || (IS4_Admin = {}));
var IS4_Admin;
(function (IS4_Admin) {
    var Membership;
...
(function (IS4_Admin) {
    ...
    })(Northwind = IS4_Admin.Northwind || (IS4_Admin.Northwind = {}));
})(IS4_Admin || (IS4_Admin = {}));
var IS4_Admin;
(function (IS4_Admin) {
    var Northwind;
...
(function (IS4_Admin) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnum(Gender, 'IS4_Admin.Northwind.Entities.Gender');
    })(Northwind = IS4_Admin.Northwind || (IS4_Admin.Northwind = {}));
})(IS4_Admin || (IS4_Admin = {}));
var IS4_Admin;
(function (IS4_Admin) {
...
(function (IS4_Admin) {
    ...
    })(Organization = IS4_Admin.Organization || (IS4_Admin.Organization = {}));
})(IS4_Admin || (IS4_Admin = {}));
var IS4_Admin;
(function (IS4_Admin) {
    var Organization;
...
var IS4_Admin;
(function (IS4_Admin) {
    var SA_Authorization;
    (function (SA_Authorization) {
        var RolesForm = /** @class */ (function (_super) {
            __extends(RolesForm, _super);
            function RolesForm() {
                return _super !== null && _super.apply(this, arguments) || this;
            }
            RolesForm.formKey = 'SA_Authorization.Roles';
            return RolesForm;
        }(Serenity.PrefixedContext));
        SA_Authorization.RolesForm = RolesForm;
        [,
            ['ConcurrencyStamp', function () { return Serenity.StringEditor; }],
            ['Name', function () { return Serenity.StringEditor; }],
            ['NormalizedName', function () { return Serenity.StringEditor; }]
    ...
    })(SA_Authorization = IS4_Admin.SA_Authorization || (IS4_Admin.SA_Authorization = {}));
})(IS4_Admin || (IS4_Admin = {}));
var IS4_Admin;
(function (IS4_Admin) {
    var SA_Authorization;
    (function (SA_Authorization) {
        ...
        (function (RolesRow) {
            RolesRow.idProperty = 'Id';
            RolesRow.nameProperty = 'Id';
            RolesRow.localTextPrefix = 'SA_Authorization.Roles';
            var Fields;
            (function (Fields) {
            })(Fields = RolesRow.Fields || (RolesRow.Fields = {}));
            [
        ...
        })(RolesRow = SA_Authorization.RolesRow || (SA_Authorization.RolesRow = {}));
    })(SA_Authorization = IS4_Admin.SA_Authorization || (IS4_Admin.SA_Authorization = {}));
})(IS4_Admin || (IS4_Admin = {}));
var IS4_Admin;
(function (IS4_Admin) {
    ...
    (function (SA_Authorization) {
        var RolesService;
        (function (RolesService) {
            RolesService.baseUrl = 'SA_Authorization/Roles';
            var Methods;
            (function (Methods) {
            })(Methods = RolesService.Methods || (RolesService.Methods = {}));
            [
        ...
        })(RolesService = SA_Authorization.RolesService || (SA_Authorization.RolesService = {}));
    })(SA_Authorization = IS4_Admin.SA_Authorization || (IS4_Admin.SA_Authorization = {}));
})(IS4_Admin || (IS4_Admin = {}));
var IS4_Admin;
(function (IS4_Admin) {
    ...
    (function (SA_Authorization) {
        var UserRolesForm = /** @class */ (function (_super) {
            ...
            UserRolesForm.formKey = 'SA_Authorization.UserRoles';
            return UserRolesForm;
        }(Serenity.PrefixedContext));
        SA_Authorization.UserRolesForm = UserRolesForm;
        [,
            ['RoleId', function () { return Serenity.StringEditor; }]
        ].forEach(function (x) { return Object.defineProperty(UserRolesForm.prototype, x[0], {
            get: function () {
...
(function (IS4_Admin) {
    ...
    (function (SA_Authorization) {
        ...
        (function (UserRolesRow) {
            UserRolesRow.idProperty = 'UserId';
            UserRolesRow.nameProperty = 'UserId';
            UserRolesRow.localTextPrefix = 'SA_Authorization.UserRoles';
            var Fields;
            (function (Fields) {
            })(Fields = UserRolesRow.Fields || (UserRolesRow.Fields = {}));
            [
        ...
        })(UserRolesRow = SA_Authorization.UserRolesRow || (SA_Authorization.UserRolesRow = {}));
    })(SA_Authorization = IS4_Admin.SA_Authorization || (IS4_Admin.SA_Authorization = {}));
})(IS4_Admin || (IS4_Admin = {}));
var IS4_Admin;
(function (IS4_Admin) {
    ...
    (function (SA_Authorization) {
        var UserRolesService;
        (function (UserRolesService) {
            UserRolesService.baseUrl = 'SA_Authorization/UserRoles';
            var Methods;
            (function (Methods) {
            })(Methods = UserRolesService.Methods || (UserRolesService.Methods = {}));
            [
        ...
        })(UserRolesService = SA_Authorization.UserRolesService || (SA_Authorization.UserRolesService = {}));
    })(SA_Authorization = IS4_Admin.SA_Authorization || (IS4_Admin.SA_Authorization = {}));
})(IS4_Admin || (IS4_Admin = {}));
var IS4_Admin;
(function (IS4_Admin) {
    ...
    (function (SA_Authorization) {
        var UsersForm = /** @class */ (function (_super) {
            ...
            UsersForm.formKey = 'SA_Authorization.Users';
            return UsersForm;
        }(Serenity.PrefixedContext));
        SA_Authorization.UsersForm = UsersForm;
        [,
            ['AccessFailedCount', function () { return Serenity.IntegerEditor; }],
            ['ConcurrencyStamp', function () { return Serenity.StringEditor; }],
            ['Email', function () { return Serenity.StringEditor; }],
...
(function (IS4_Admin) {
    ...
    (function (SA_Authorization) {
        ...
        (function (UsersRow) {
            UsersRow.idProperty = 'Id';
            UsersRow.nameProperty = 'Id';
            UsersRow.localTextPrefix = 'SA_Authorization.Users';
            var Fields;
            (function (Fields) {
            })(Fields = UsersRow.Fields || (UsersRow.Fields = {}));
            [
        ...
        })(UsersRow = SA_Authorization.UsersRow || (SA_Authorization.UsersRow = {}));
    })(SA_Authorization = IS4_Admin.SA_Authorization || (IS4_Admin.SA_Authorization = {}));
})(IS4_Admin || (IS4_Admin = {}));
var IS4_Admin;
(function (IS4_Admin) {
    ...
    (function (SA_Authorization) {
        var UsersService;
        (function (UsersService) {
            UsersService.baseUrl = 'SA_Authorization/Users';
            var Methods;
            (function (Methods) {
            })(Methods = UsersService.Methods || (UsersService.Methods = {}));
            [
        ...
        })(UsersService = SA_Authorization.UsersService || (SA_Authorization.UsersService = {}));
    })(SA_Authorization = IS4_Admin.SA_Authorization || (IS4_Admin.SA_Authorization = {}));
})(IS4_Admin || (IS4_Admin = {}));
var IS4_Admin;
(function (IS4_Admin) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = IS4_Admin.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = IS4_Admin.LanguageList || (IS4_Admin.LanguageList = {}));
})(IS4_Admin || (IS4_Admin = {}));
...
(function (IS4_Admin) {
    ...
    (function (ScriptInitialization) {
        ...
        Serenity.EntityDialog.defaultLanguageList = IS4_Admin.LanguageList.getValue;
    })(ScriptInitialization = IS4_Admin.ScriptInitialization || (IS4_Admin.ScriptInitialization = {}));
})(IS4_Admin || (IS4_Admin = {}));
var IS4_Admin;
(function (IS4_Admin) {
    var Administration;
...
(function (IS4_Admin) {
    ...
    IS4_Admin.BasicProgressDialog = BasicProgressDialog;
})(IS4_Admin || (IS4_Admin = {}));
var IS4_Admin;
(function (IS4_Admin) {
    var Common;
    (function (Common) {
        var BulkServiceAction = /** @class */ (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new IS4_Admin.BasicProgressDialog();
...
(function (IS4_Admin) {
    ...
    })(DialogUtils = IS4_Admin.DialogUtils || (IS4_Admin.DialogUtils = {}));
})(IS4_Admin || (IS4_Admin = {}));
var IS4_Admin;
(function (IS4_Admin) {
    var Common;
...
(function (IS4_Admin) {
    ...
    IS4_Admin.StaticTextBlock = StaticTextBlock;
})(IS4_Admin || (IS4_Admin = {}));
var IS4_Admin;
(function (IS4_Admin) {
    var Common;
...
(function (IS4_Admin) {
    ...
    (function (Meeting) {
        ...
        }(IS4_Admin.Common.GridEditorDialog));
...
(function (IS4_Admin) {
    ...
    (function (Meeting) {
        var MeetingAttendeeEditor = /** @class */ (function (_super) {
            ...
            MeetingAttendeeEditor.prototype.createToolbarExtensions = function () {
                ...
                Serenity.Widget.create({
                    type: Serenity.LookupEditor,
                    options: {
                        lookupKey: IS4_Admin.Organization.ContactRow.lookupKey
                    },
                    ...
                    init: function (w) { return w.changeSelect2(function (x) {
                        if (Q.isEmptyOrNull(w.value))
                            return;
                        var contact = IS4_Admin.Organization.ContactRow.getLookup().itemById[Q.toId(w.value)];
                        w.value = null;
                        if (!contact)
                            return;
        ...
        }(IS4_Admin.Common.GridEditorBase));
    ...
    (function (Northwind) {
        var CustomerDialog = /** @class */ (function (_super) {
            ...
            function CustomerDialog() {
                ...
                IS4_Admin.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
    ...
    (function (Northwind) {
        var CustomerGrid = /** @class */ (function (_super) {
            ...
            CustomerGrid.prototype.getButtons = function () {
                ...
                buttons.push(IS4_Admin.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    service: 'Northwind/Customer/ListExcel',
                    separator: true
                }));
                buttons.push(IS4_Admin.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); }
                }));
                return buttons;
    ...
    (function (Northwind) {
        var OrderDialog = /** @class */ (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(IS4_Admin.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
                    cssClass: 'export-pdf-button',
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        IS4_Admin.Common.ReportHelper.execute({
                            reportKey: 'Northwind.OrderDetail',
                            params: {
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: IS4_Admin.Authorization.userDefinition.DisplayName,
    ...
    (function (Northwind) {
        var RegionDialog = /** @class */ (function (_super) {
            ...
            RegionDialog.prototype.getLanguages = function () {
                return IS4_Admin.LanguageList.getValue();
            };
...
(function (IS4_Admin) {
    var SA_Authorization;
    (function (SA_Authorization) {
        var RolesDialog = /** @class */ (function (_super) {
            __extends(RolesDialog, _super);
            function RolesDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new SA_Authorization.RolesForm(_this.idPrefix);
                return _this;
            }
            RolesDialog.prototype.getFormKey = function () { return SA_Authorization.RolesForm.formKey; };
            RolesDialog.prototype.getIdProperty = function () { return SA_Authorization.RolesRow.idProperty; };
            RolesDialog.prototype.getLocalTextPrefix = function () { return SA_Authorization.RolesRow.localTextPrefix; };
            RolesDialog.prototype.getNameProperty = function () { return SA_Authorization.RolesRow.nameProperty; };
            RolesDialog.prototype.getService = function () { return SA_Authorization.RolesService.baseUrl; };
        ...
        SA_Authorization.RolesDialog = RolesDialog;
    })(SA_Authorization = IS4_Admin.SA_Authorization || (IS4_Admin.SA_Authorization = {}));
})(IS4_Admin || (IS4_Admin = {}));
var IS4_Admin;
(function (IS4_Admin) {
    var SA_Authorization;
    (function (SA_Authorization) {
        var RolesGrid = /** @class */ (function (_super) {
            __extends(RolesGrid, _super);
            function RolesGrid(container) {
                return _super.call(this, container) || this;
            }
            RolesGrid.prototype.getColumnsKey = function () { return 'SA_Authorization.Roles'; };
            RolesGrid.prototype.getDialogType = function () { return SA_Authorization.RolesDialog; };
            RolesGrid.prototype.getIdProperty = function () { return SA_Authorization.RolesRow.idProperty; };
            RolesGrid.prototype.getLocalTextPrefix = function () { return SA_Authorization.RolesRow.localTextPrefix; };
            RolesGrid.prototype.getService = function () { return SA_Authorization.RolesService.baseUrl; };
            RolesGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RolesGrid);
            return RolesGrid;
        }(Serenity.EntityGrid));
        SA_Authorization.RolesGrid = RolesGrid;
    })(SA_Authorization = IS4_Admin.SA_Authorization || (IS4_Admin.SA_Authorization = {}));
})(IS4_Admin || (IS4_Admin = {}));
var IS4_Admin;
(function (IS4_Admin) {
    var SA_Authorization;
    (function (SA_Authorization) {
        var UserRolesDialog = /** @class */ (function (_super) {
            __extends(UserRolesDialog, _super);
            function UserRolesDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new SA_Authorization.UserRolesForm(_this.idPrefix);
                return _this;
            }
            UserRolesDialog.prototype.getFormKey = function () { return SA_Authorization.UserRolesForm.formKey; };
            UserRolesDialog.prototype.getIdProperty = function () { return SA_Authorization.UserRolesRow.idProperty; };
            UserRolesDialog.prototype.getLocalTextPrefix = function () { return SA_Authorization.UserRolesRow.localTextPrefix; };
            UserRolesDialog.prototype.getNameProperty = function () { return SA_Authorization.UserRolesRow.nameProperty; };
            UserRolesDialog.prototype.getService = function () { return SA_Authorization.UserRolesService.baseUrl; };
            UserRolesDialog = __decorate([
                Serenity.Decorators.registerClass(),
                Serenity.Decorators.responsive()
            ], UserRolesDialog);
            return UserRolesDialog;
        }(Serenity.EntityDialog));
        SA_Authorization.UserRolesDialog = UserRolesDialog;
    })(SA_Authorization = IS4_Admin.SA_Authorization || (IS4_Admin.SA_Authorization = {}));
})(IS4_Admin || (IS4_Admin = {}));
var IS4_Admin;
(function (IS4_Admin) {
    var SA_Authorization;
    (function (SA_Authorization) {
        var UserRolesGrid = /** @class */ (function (_super) {
            __extends(UserRolesGrid, _super);
            function UserRolesGrid(container) {
                return _super.call(this, container) || this;
            }
            UserRolesGrid.prototype.getColumnsKey = function () { return 'SA_Authorization.UserRoles'; };
            UserRolesGrid.prototype.getDialogType = function () { return SA_Authorization.UserRolesDialog; };
            UserRolesGrid.prototype.getIdProperty = function () { return SA_Authorization.UserRolesRow.idProperty; };
            UserRolesGrid.prototype.getLocalTextPrefix = function () { return SA_Authorization.UserRolesRow.localTextPrefix; };
            UserRolesGrid.prototype.getService = function () { return SA_Authorization.UserRolesService.baseUrl; };
            UserRolesGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], UserRolesGrid);
            return UserRolesGrid;
        }(Serenity.EntityGrid));
        SA_Authorization.UserRolesGrid = UserRolesGrid;
    })(SA_Authorization = IS4_Admin.SA_Authorization || (IS4_Admin.SA_Authorization = {}));
})(IS4_Admin || (IS4_Admin = {}));
var IS4_Admin;
(function (IS4_Admin) {
    ...
    (function (SA_Authorization) {
        var UsersDialog = /** @class */ (function (_super) {
            ...
            function UsersDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new SA_Authorization.UsersForm(_this.idPrefix);
                return _this;
            }
            UsersDialog.prototype.getFormKey = function () { return SA_Authorization.UsersForm.formKey; };
            UsersDialog.prototype.getIdProperty = function () { return SA_Authorization.UsersRow.idProperty; };
            UsersDialog.prototype.getLocalTextPrefix = function () { return SA_Authorization.UsersRow.localTextPrefix; };
            UsersDialog.prototype.getNameProperty = function () { return SA_Authorization.UsersRow.nameProperty; };
            UsersDialog.prototype.getService = function () { return SA_Authorization.UsersService.baseUrl; };
        ...
        SA_Authorization.UsersDialog = UsersDialog;
    })(SA_Authorization = IS4_Admin.SA_Authorization || (IS4_Admin.SA_Authorization = {}));
})(IS4_Admin || (IS4_Admin = {}));
var IS4_Admin;
(function (IS4_Admin) {
    ...
    (function (SA_Authorization) {
        var UsersGrid = /** @class */ (function (_super) {
            ...
            UsersGrid.prototype.getColumnsKey = function () { return 'SA_Authorization.Users'; };
            UsersGrid.prototype.getDialogType = function () { return SA_Authorization.UsersDialog; };
            UsersGrid.prototype.getIdProperty = function () { return SA_Authorization.UsersRow.idProperty; };
            UsersGrid.prototype.getLocalTextPrefix = function () { return SA_Authorization.UsersRow.localTextPrefix; };
            UsersGrid.prototype.getService = function () { return SA_Authorization.UsersService.baseUrl; };
            UsersGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], UsersGrid);
            return UsersGrid;
        }(Serenity.EntityGrid));
        SA_Authorization.UsersGrid = UsersGrid;
    })(SA_Authorization = IS4_Admin.SA_Authorization || (IS4_Admin.SA_Authorization = {}));
})(IS4_Admin || (IS4_Admin = {}));
var IS4_Admin;
(function (IS4_Admin) {
...
(function (IS4_Admin) {
    ...
    (function (BasicSamples) {
        ...
        }(IS4_Admin.Northwind.ProductDialog));
...
(function (IS4_Admin) {
    ...
    (function (BasicSamples) {
        ...
        }(IS4_Admin.Northwind.ProductGrid));
        ...
        var DefaultValuesInNewGrid = /** @class */ (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: IS4_Admin.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: IS4_Admin.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new IS4_Admin.Northwind.OrderDialog();
                        ...
                        var chai = IS4_Admin.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = IS4_Admin.Northwind.EmployeeRow.getLookup().items
...
(function (IS4_Admin) {
    ...
    (function (BasicSamples) {
        ...
        }(IS4_Admin.Northwind.OrderDialog));
...
(function (IS4_Admin) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = /** @class */ (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    IS4_Admin.Northwind.CategoryService.Retrieve({
        ...
        }(IS4_Admin.Northwind.CategoryDialog));
...
(function (IS4_Admin) {
    ...
    (function (BasicSamples) {
        ...
        }(IS4_Admin.Northwind.CategoryGrid));
        ...
        var OtherFormInTabDialog = /** @class */ (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    ...
                    items: Q.getForm(IS4_Admin.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new IS4_Admin.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                IS4_Admin.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(IS4_Admin.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    IS4_Admin.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(IS4_Admin.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(IS4_Admin.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    IS4_Admin.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return IS4_Admin.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return IS4_Admin.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return IS4_Admin.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return IS4_Admin.Northwind.OrderService.baseUrl; };
...
(function (IS4_Admin) {
    ...
    (function (BasicSamples) {
        ...
        }(IS4_Admin.Northwind.SupplierDialog));
...
(function (IS4_Admin) {
    ...
    (function (BasicSamples) {
        ...
        var ReadOnlyGrid = /** @class */ (function (_super) {
            ...
            return ReadOnlyGrid;
        }(IS4_Admin.Northwind.SupplierGrid));
...
(function (IS4_Admin) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = /** @class */ (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return IS4_Admin.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return IS4_Admin.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return IS4_Admin.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return IS4_Admin.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return IS4_Admin.Northwind.OrderService.baseUrl; };
...
(function (IS4_Admin) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = /** @class */ (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    IS4_Admin.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(IS4_Admin.Northwind.CustomerDialog));
...
(function (IS4_Admin) {
    ...
    (function (BasicSamples) {
        ...
        }(IS4_Admin.Northwind.CustomerGrid));
        ...
        var ChangingLookupTextDialog = /** @class */ (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    var productID = Q.toId(_this.form.ProductID.value);
                    if (productID != null) {
                        _this.form.UnitPrice.value = IS4_Admin.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
                _this.form.Discount.addValidationRule(_this.uniqueName, function (e) {
                    var price = _this.form.UnitPrice.value;
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return IS4_Admin.Northwind.OrderDetailRow.localTextPrefix; };
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = /** @class */ (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return IS4_Admin.Northwind.ProductRow.lookupKey;
            };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = /** @class */ (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new IS4_Admin.Northwind.OrderDetailForm(_this.idPrefix);
                ...
                _this.form.ProductID.cascadeField = IS4_Admin.Northwind.ProductRow.Fields.CategoryID;
                return _this;
        ...
        }(IS4_Admin.Northwind.OrderDetailDialog));
...
(function (IS4_Admin) {
    ...
    (function (BasicSamples) {
        ...
        }(IS4_Admin.Northwind.OrderDetailsEditor));
...
(function (IS4_Admin) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = /** @class */ (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return IS4_Admin.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return IS4_Admin.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return IS4_Admin.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return IS4_Admin.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = /** @class */ (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return IS4_Admin.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (IS4_Admin) {
    ...
    (function (BasicSamples) {
        ...
        }(IS4_Admin.Common.BulkServiceAction));
...
(function (IS4_Admin) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = /** @class */ (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return IS4_Admin.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return IS4_Admin.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return IS4_Admin.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return IS4_Admin.Northwind.ProductService.baseUrl; };
            /**
            ...
            ConditionalFormattingGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = IS4_Admin.Northwind.ProductRow.Fields;
    ...
    (function (BasicSamples) {
        var CustomLinksInGrid = /** @class */ (function (_super) {
            ...
            CustomLinksInGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = IS4_Admin.Northwind.OrderRow.Fields;
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(IS4_Admin.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new IS4_Admin.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new IS4_Admin.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new IS4_Admin.Northwind.OrderDialog().loadEntityAndOpenDialog({
                    ...
                    var countryFilter = this.findQuickFilter(Serenity.LookupEditor, IS4_Admin.Northwind.OrderRow.Fields.ShipCountry);
...
(function (IS4_Admin) {
    ...
    IS4_Admin.SelectableEntityGrid = SelectableEntityGrid;
})(IS4_Admin || (IS4_Admin = {}));
...
(function (IS4_Admin) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = /** @class */ (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return IS4_Admin.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return IS4_Admin.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return IS4_Admin.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return IS4_Admin.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(IS4_Admin.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = /** @class */ (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == fld.ShippingState; }).init = function (w) {
                    ...
                    w.value = IS4_Admin.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            IS4_Admin.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (IS4_Admin) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = /** @class */ (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return IS4_Admin.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return IS4_Admin.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return IS4_Admin.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return IS4_Admin.Northwind.ProductService.baseUrl; };
...
(function (IS4_Admin) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = /** @class */ (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return IS4_Admin.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return IS4_Admin.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return IS4_Admin.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return IS4_Admin.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
...
(function (IS4_Admin) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = /** @class */ (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return IS4_Admin.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return IS4_Admin.Northwind.CustomerGrossSalesRow.localTextPrefix; };
        ...
        var TreeGrid = /** @class */ (function (_super) {
            ...
            function TreeGrid(container) {
                ...
                _this.treeMixin = new Serenity.TreeGridMixin({
                    ...
                    toggleField: IS4_Admin.Northwind.OrderRow.Fields.CustomerCompanyName,
...
(function (IS4_Admin) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = /** @class */ (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return IS4_Admin.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return IS4_Admin.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return IS4_Admin.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
...
//# sourceMappingURL=IS4_Admin.Web.js.map